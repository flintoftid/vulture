...
print( 'dgref_pml12_GRE_e' , '-depsc2' );
...
print( sprintf( 'dgref_pml12_LRE_E2_%.1fGHz.eps' , fGHz ) , '-depsc2' );

assert( db20( maxLRE_ex ) < -130 );
assert( db20( maxLRE_ey ) < -130 );
assert( db20( maxLRE_ez ) < -130 );
assert( db10( maxGRE_e )  < -115 );
assert( db20( maxLRE_Ex ) < -42 );
assert( db20( maxLRE_Ey ) < -42 );
assert( db20( maxLRE_Ez ) < -42);
assert( db10( maxGRE_E )  < -38 );
