...
# Plot mesh.
gvulture -p planewave.mesh
gnuplot mesh.gnp
mv mesh.eps planewave_mesh.eps

# Run solver.
vulture -v planewave.mesh
...
gnuplot plot_tds60.gnp

# Extract surface plot of time response at time-step 100.
cat > process.dat << EOF
CE  Vulture example: Plane wave in free-space.
1
 0 20 1 0 40 1 10 10 1
